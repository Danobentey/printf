...
````
This is the first group project that we have at Alx, which consists of replicating the **[printf (3)](http://man7.org/linux/man-pages/man3/printf.3.html)** function of language c, calling it this way **_printf.**
...
```
## Contributors
- [Daniel Obentey](https://github.com/danobentey)
- [Nellyjoy Makena](https://github.com/)
